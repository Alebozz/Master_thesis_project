...
Now you can launch the program to take the survey and at the end you can report your results by sending the auto-generated "results.txt" file using the survey at the Answer link below, where you can also report any problem encountered when trying to take the survey.
...
- After the last sample is evaluated, the program automatically generate a "results.txt" file reporting all your answers and then the program will close.
...
- At the end, to complete the survey you will need to send the "results.txt" file using the Answer link () where you can also report any problems with the program (feedback is highly appreciated)
